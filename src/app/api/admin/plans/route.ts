...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const formattedPlans = plans.map(plan => ({
      ...
      ngnPrice: plan.ngnPrice ? Number(plan.ngnPrice) : null,
      usdPrice: plan.usdPrice ? Number(plan.usdPrice) : null,
      generatedNgnPrice: plan.generatedNgnPrice ? Number(plan.generatedNgnPrice) : null,
      generatedUsdPrice: plan.generatedUsdPrice ? Number(plan.generatedUsdPrice) : null,
      exchangeRate: plan.exchangeRate ? Number(plan.exchangeRate) : null,
      exchangeRateSource: plan.exchangeRateSource,
  ...
  try {
    ...
    const plan = await prisma.plan.create({
      data: {
        ...
        ngnPrice: ngnPrice || null,
        usdPrice: usdPrice || null,
        generatedNgnPrice: generatedNgnPrice || null,
        generatedUsdPrice: generatedUsdPrice || null,
