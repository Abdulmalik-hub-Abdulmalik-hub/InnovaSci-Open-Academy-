  ...
  try {
    ...
    const scholarship = await prisma.scholarship.create({
      data: {
        ...
        requiredDocuments: validatedData.requiredDocuments ? JSON.stringify(validatedData.requiredDocuments) : null,
        ...
        applicableDomains: validatedData.applicableDomains ? JSON.stringify(validatedData.applicableDomains) : null,
        applicableCategories: validatedData.applicableCategories ? JSON.stringify(validatedData.applicableCategories) : null,
        applicableDifficulties: validatedData.applicableDifficulties ? JSON.stringify(validatedData.applicableDifficulties) : null,
